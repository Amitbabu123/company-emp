              ...
              <MDBCard className="mb-4">
                <MDBCardBody className="text-center">
                  <MDBCardImage
                    ...
                    style={{ width: '228px' }}
                    fluid />
                  <p className="text-muted mb-1">Employee Name</p>
              ...
              <MDBCard className="mb-4">
                <MDBCardBody>
                  ...
                  <MDBRow>
                    ...
                    <MDBCol sm="9">
                      <MDBCardText className="text-muted">21-04-1999</MDBCardText>
                    </MDBCol>
                  </MDBRow>
                  <hr />
                  <MDBRow>
                  ...
                  <MDBRow>
                    ...
                    <MDBCol sm="9">
                      <MDBCardText className="text-muted">12/10/2020</MDBCardText>
                    </MDBCol>
                  </MDBRow>
                  <hr />
                  <MDBRow>
                    <MDBCol sm="3">
                      <MDBCardText>P.Tax</MDBCardText>
                    </MDBCol>
                    <MDBCol sm="9">
